/**
 * package contains identifer of a string in a string 
 */
package regex;
...
/**
 * class RegexDynamicExpressionCheck has a main method that identifies and 
 * displays a pattern introduced by the user into a source string introduced 
 * also by the user   
 * @author miroslavzsuchanszki
 */
